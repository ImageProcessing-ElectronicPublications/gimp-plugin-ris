...
const char PLUG_IN_TITLE[]     = "Reverse Interpolate Scale";
const char PLUG_IN_PROCEDURE[] = "filter-ris";
const char PLUG_IN_ROLE[]      = "gimp-ris";
const char PLUG_IN_BINARY[]    = "gimp-plugin-ris";
