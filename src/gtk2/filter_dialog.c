...
extern const char PLUG_IN_TITLE[];
...
gboolean pixel_art_scalers_dialog (GimpDrawable *drawable)
{
    ...
    dialog = gimp_dialog_new (PLUG_IN_TITLE, PLUG_IN_ROLE, NULL, 0, gimp_standard_help_func, PLUG_IN_PROCEDURE, GTK_STOCK_CANCEL, GTK_RESPONSE_CANCEL, GTK_STOCK_OK, GTK_RESPONSE_OK, NULL);
